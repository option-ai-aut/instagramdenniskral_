...
function LoginForm() {
  ...
  return (
    ...
    >
      <div className="absolute inset-0 bg-gradient-to-br from-[#1d4ed8]/10 via-transparent to-[#60a5fa]/5" />
          ...
          <div>
            ...
            <div className="relative">
              <input
                ...
                autoFocus
                className="w-full rounded-xl px-3 py-3 text-sm text-white/80 placeholder-white/20 focus:outline-none focus:ring-1 focus:ring-[#1d4ed8]/50 pr-10"
                style={{
